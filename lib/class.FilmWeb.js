...
function createBrowser ()
{
    ...
    let browser = new webdriver.Builder()
        .withCapabilities(
            ...
            webdriver.Capabilities.phantomjs().set('phantomjs.page.settings.userAgent', USER_AGENT)
        )
        .build();
    ...
    browser.waitUntilElementLocated =
        (selector) => browser.wait(webdriver.until.elementLocated(webdriver.By.css(selector)));
...
function rate (url, value, review)
{
    ...
    return bootstrap.call(this, url)
        .then(() => browser.waitUntilElementLocated('#filmVoteRatingPanel .rateButtons[data-rate] [data-index]'))
...
class FilmWeb
{
    ...
    search (query, page=1)
    {
        ...
        return bootstrap.call(this, url)
            .then(() => browser.waitUntilElementLocated('.newPaginator'))
    ...
    authenticate (login, password)
    {
        ...
        return bootstrap.call(this, AUTH_URL)
            ...
            .then(() => browser.waitUntilElementLocated('.loggedUserInfo'))
            .catch(error => {
